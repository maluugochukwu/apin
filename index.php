    ...
    <section class="slider">
      <div class="slick-carousel m-slides-0"
        ...
        <div class="slide-item align-v-h">
          <div class="bg-img"><img src="assets/images/sliders/hepatitis.jpg" alt="slide img"></div>
          <div class="container">
            <div class="row align-items-center">
                ...
                <div class="slide__content">
                  ...
                  <ul class="features-list list-unstyled mb-0 d-flex flex-wrap">
                    ...
                    <li class="feature-item">
                      ...
                      <h2 class="feature__title" style="color:#ffffff" >Examination</h2>
                    </li><!-- /.feature-item-->
                    <!-- feature item #2 -->
                    <li class="feature-item">
                      <div class="feature__icon">
                      ...
                      <h2 class="feature__title" style="color:#ffffff">Prescription </h2>
                    </li><!-- /.feature-item-->
                    <!-- feature item #3 -->
                    <li class="feature-item">
                      <div class="feature__icon">
                      ...
                      <h2 class="feature__title" style="color:#ffffff">Cardiogram</h2>
                    </li><!-- /.feature-item-->
                    <!-- feature item #4 -->
                    <li class="feature-item">
                      <div class="feature__icon">
                      ...
                      <h2 class="feature__title"  style="color:#ffffff">Blood Pressure</h2>
                    </li><!-- /.feature-item-->
                  </ul><!-- /.features-list -->
                </div><!-- /.slide-content -->
              </div><!-- /.col-xl-7 -->
