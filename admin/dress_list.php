  ...
  <style>
   ...
   <div class="card">
    <div class="card-header">
        <h5 class="card-title">Dress List</h5>
        <h6 class="card-subtitle text-muted">The report contains Dresses that have been setup in the system.</h6>
    </div>
    <div class="card-body">
     <div class="row">
        <?php
         if($_SESSION['role_id_sess'] == 002 || $_SESSION['role_id_sess'] == 001  )
         {
        ?>
         <div class="col-sm-2">
             <a class="btn btn-info" onclick="getModal('setup/dress.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary"><i class="fa fa-plus"></i> Add Dress</a>
         </div>
        <?php
     }
        ?>
          <div class="col-sm-3">
             <a class="btn btn-secondary" onclick="getModal('setup/book_dress.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary"> <i class="fa fa-book"></i> Book a dress</a>
         </div> 
