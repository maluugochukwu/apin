...
//                                            }
		...
		<div class="main" >
			<nav class="navbar navbar-expand navbar-light bg-white">
                ...
                &nbsp; &nbsp; | &nbsp; &nbsp; 
                <a href="javascript:void(0)" class="d-flex mr-2" >
                    Branch: &nbsp; <span style="font-weight:bold; color:#000"><?php  echo $dbobject->getitemlabel('branch','id',$_SESSION['branch_id'],'name');?></span>
                </a>
                <?php
                }
                ?>
...
//            console.log(steps);
   ...
   ht().then((ee)=>{ console.log(JSON.stringify(ee))
    ...
    subtitle: {
        text: 'Source map: <a href="#">RENT A DRESS</a>'
    },
